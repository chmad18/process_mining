...
for log_file in log_files:
    ...
    reference_model_log = xes_importer.apply('Scenario1/logNormal.xes')
    reference_net, reference_initial_marking, reference_final_marking = heuristics_miner.apply(reference_model_log)
...
compare_statistics_to_expected_and_save('results/actual_statistics.csv',
                                        ...
                                        '../../../comparison_results/scenario1_heuristics_comparison_analysis.csv')
